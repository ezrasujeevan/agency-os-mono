...
const DeliveryRenderActionCell: React.FC<GridRenderCellParams<Delivery.Delivery, any>> = ({
    ...
    const handleSwitchAccess = () => {
        console.log('Switch Access', row.id)
    }
    const handleEditAccess = () => {
        console.log('Edit Access', row.id)
    }
    const handleUpdateAccess = () => {
        console.log('Update Access', row.id)
    }
    const handleHistory = () => {
        console.log('History', row.id)
    }
    return (
        <ButtonGroup variant="contained" aria-label="Basic button group">
            ...
            <Button onClick={handleEditAccess} color={'secondary'}>
                Edit
            </Button>
